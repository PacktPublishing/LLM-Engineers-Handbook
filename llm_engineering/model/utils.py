...
class ResourceManager:
    ...
    def endpoint_config_exists(self, endpoint_config_name: str) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Endpoint configuration '{endpoint_config_name}' exists.")  # noqa: G004
            return True
        except ClientError:
            self.logger.info(f"Endpoint configuration '{endpoint_config_name}' does not exist.")  # noqa: G004
            return False
    ...
    def endpoint_exists(self, endpoint_name: str) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Endpoint '{endpoint_name}' exists.")  # noqa: G004
            return True
        except self.sagemaker_client.exceptions.ResourceNotFoundException:
            self.logger.info(f"Endpoint '{endpoint_name}' does not exist.")  # noqa: G004
            return False
