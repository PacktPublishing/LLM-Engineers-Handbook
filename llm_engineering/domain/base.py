...
class VectorDBDataModel(DataModel, ABC):
    ...
    @classmethod
    def bulk_insert(cls, documents: list["VectorDBDataModel"]):
    ...
    def group_by_collection(
        cls, documents: list["VectorDBDataModel"]
    ) -> dict["VectorDBDataModel", list["VectorDBDataModel"]]:
        grouped = {}
    ...
    @classmethod
    def collection_name_to_class(cls, collection_name: str) -> type["VectorDBDataModel"]:
